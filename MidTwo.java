...
public class MidTwo extends JFrame implements ActionListener{
    ...
    MidTwo(){
        ...
        JLabel heading = new JLabel("Enter MID-2 Marks of Student");
         ...
         //   String s9=(String)tfsub9.getText();
           ...
           // String m10=(String)tfmarks10.getText();
            ...
            try{
                ...
                Conn c1=new Conn();
                String query1="insert into midtwos values('"+roll+"','"+sem+"','"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"')";
                
                String query2="insert into midtwom values('"+roll+"','"+sem+"','"+m1+"','"+m2+"','"+m3+"','"+m4+"','"+m5+"','"+m6+"','"+m7+"','"+m8+"')";
