...
public class M2results extends JFrame implements ActionListener{
     JButton cancel;
     String roll,sem;
    M2results(String roll,String sem){
        this.roll=roll;
        this.sem=sem;
          setSize(500, 600);
        setLocation(500, 100);
        ...
        JLabel heading = new JLabel("MID-2 Results:");
        ...
        try {
            ...
            ResultSet rs1 = c.s.executeQuery("select * from midtwos where Roll_No = '"+roll+"' and Semister ='"+sem+"' ");
            while(rs1.next()) {
                sub1.setText(rs1.getString("sub1"));
                sub2.setText(rs1.getString("sub2"));
                sub3.setText(rs1.getString("sub3"));
            ...
            ResultSet rs2 = c.s.executeQuery("select * from midtwom where Roll_No = '"+roll+"' and Semister ='"+sem+"'  ");
            while(rs2.next()) {
                sub1.setText(sub1.getText() + "                       " + rs2.getString("m1"));
                sub2.setText(sub2.getText() + "                       " + rs2.getString("m2"));
                sub3.setText(sub3.getText() + "                        " + rs2.getString("m3"));
